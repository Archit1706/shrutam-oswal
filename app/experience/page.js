            ...
            <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="relative">
                        ...
                        <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-teal-500 via-lime-500 to-teal-500 opacity-30"></div>
                                ...
                                >
                                    <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 items-center ${index % 2 === 0 ? '' : 'md:flex-row-reverse'
                                        ...
                                        <div className={`${index % 2 === 0 ? 'md:text-right md:pr-12' : 'md:pl-12 md:col-start-2'}`}>
                                            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-teal-400/50 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-teal-500/20">
                                                ...
                                                <p className="text-teal-300 font-semibold mb-1">{exp.company}</p>
                                                {exp.department && (
                                        ...
                                        <div className={`${index % 2 === 0 ? 'md:pl-12 md:col-start-2' : 'md:pr-12'}`}>
                                            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-teal-400/50 transition-all duration-300">
                                                {/* Responsibilities */}
                                                <div className="mb-6">
                                                ...
                                                <div className="mb-6">
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {exp.technologies.map((tech, tIndex) => (
                                                            <span
                                                                key={tIndex}
                                                                className="px-3 py-1 bg-teal-500/20 text-teal-300 rounded-full text-xs font-semibold border border-teal-400/30 hover:bg-teal-500/30 transition-colors"
                                                            >
                                                                {tech}
                                                            </span>
                                                        ))}
